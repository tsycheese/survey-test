        ...
        {option.imageUrl ? (
          <>
            ...
            <button
              ...
              className="text-destructive-foreground absolute top-1 right-1 rounded-full bg-destructive/90 p-1 opacity-0 transition-opacity group-hover:opacity-100"
            >
              <X className="h-3 w-3" />
            </button>
          </>
          ...
          <div>
            {isEditingTitle ? (
              ...
              <div
                ...
                className="cursor-text py-2 text-center text-sm font-medium text-foreground"
              >
                {option.title || "添加标题..."}
              </div>
            )}
          ...
          <div>
            {isEditingLabel ? (
              ...
              <div
                ...
                className="flex min-h-[44px] cursor-text items-center justify-center py-2 text-center text-sm text-muted-foreground"
              >
                {option.label || "添加说明..."}
              </div>
            )}
